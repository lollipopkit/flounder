...
- The map phase is the foundation of the audit. The dig coverage target (for example, audit until 30 project scopes are done) is NOT a map target and NOT a stopping condition; it only controls how many already-mapped scopes a later dig batch audits.
